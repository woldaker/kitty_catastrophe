...
// Single points are stored as "=(X,Y)"
// Multiple points (i.e. wall sections) are stored as "=(X1,Y1):(X2,Y2)" [":(Xn,Yn)"]...
//constexpr TCHAR POINT_SEPARATOR = ':';
...
{
    return MAP::IsValidPoint( /*FIntPoint*/{x,y} );
}
